...
class Task01Queries {
    ...
    public function query01(string|null $last_name, string|null $passport): array {

        if (empty($last_name) || empty($passport))
    ...
    public function query04(string | null $passport): array {
    ...
    public function query05(): array {
        ...
        $q->execute();
        return $q->fetchAll(PDO::FETCH_CLASS, 'Models\Task01\Examiner');
    }
