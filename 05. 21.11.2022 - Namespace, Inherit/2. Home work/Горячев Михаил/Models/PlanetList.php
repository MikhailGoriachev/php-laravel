...
class PlanetList
{
    ...
    public function __construct()
    {
        if (!$this->load()) {
            $this->save([
                new Planet(1,"Меркурий", 2_439.7, 3.304e23, 0, 0.39, "mercury.png"),
                new Planet(2,"Венера", 6_051.8, 4.872e24, 0, 0.72, "venera.jpg"),
                new Planet(3,"Земля", 6_371, 5.978e24, 1, 1.0, "earth.jpg"),
                new Planet(4,"Марс", 3_389.5, 6.423e24, 2, 1.52, "mars.jpg"),
                new Planet(5,"Юпитер", 69_911, 1.900e23, 16, 5.2, "upiter.jpg"),
                new Planet(6,"Сатурн", 58_232, 5.689e26, 30, 9.54, "saturn.png"),
                new Planet(7,"Уран", 25_362, 8.72e25, 15, 19.19, "uran.jpg"),
                new Planet(8,"Нептун", 24_622, 1.03e26, 6, 30.07, "neptun.jpg"),
            ]);
    ...
    function toTableHTML(): string
    {
        ...
        $html .= array_reduce($this->list, fn($p, $c) => $p .
                '<tr>' .
                    '<td>' . $c->getId() . '</td>' .
