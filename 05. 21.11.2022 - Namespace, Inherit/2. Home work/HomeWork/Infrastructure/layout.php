            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link mx-3 <?= activeClass($activeTab, "task01Page") ?>"
                       href="../pages/task01/goodsList.php">
                        Товары
                    </a>
                </li>
                ...
                <!-- Задание 2 -->
                <li class="nav-item">
                    <a class="nav-link mx-3 <?= activeClass($activeTab, "task02Page") ?>"
                       href="../pages/task02Page.php">
                        Трамваи
                    </a>
                </li>
                ...
                <!-- Задание 3 -->
                <li class="nav-item">
                    <a class="nav-link mx-3 <?= activeClass($activeTab, "task03Page") ?>"
                       href="../pages/task03Page.php">
                        Планеты
                    </a>
                </li>
