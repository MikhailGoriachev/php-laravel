...
class Planet {
    ...
    public function setType(string $type): void {
        $this->type = !empty($type) ? $type : throw new Exception("Planet: поле Type не может быть пустым!");
    }
    ...
    // конструктор
    public function __construct(int $id, string $name, float $radius, string $type, float $mass, int $amountSatellites, float $distance, string $image) {
        $this->setId($id);
        $this->setName($name);
