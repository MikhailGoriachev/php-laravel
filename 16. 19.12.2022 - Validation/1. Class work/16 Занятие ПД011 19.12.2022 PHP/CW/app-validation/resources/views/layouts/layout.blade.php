            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="appNavbar-1">
                    <ul class="navbar-nav">
                        ...
                        {{-- Переход на страницу загрузки файла на сервер --}}
                        <li class="nav-item">
                            <a class="nav-link @yield('active_upload')" href="/upload-file"
                               title="Переход на страницу загрузки файла на сервер">Загрузка файла</a>
                        </li>

                        {{-- Переход на страницу скачивания файла с сервера --}}
                        <li class="nav-item">
                            <a class="nav-link @yield('active_download')" href="/download-file"
                               title="Переход на страницу скачивания файла с сервера">Скачивание файла</a>
                        </li>
