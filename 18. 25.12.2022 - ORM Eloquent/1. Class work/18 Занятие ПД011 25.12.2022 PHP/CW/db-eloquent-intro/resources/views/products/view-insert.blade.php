...
@section('active_insert', 'active')

<!-- секция контент -->
@section('main_part')
    <h4 class="text-center my-5">Добавление записи о товаре</h4>
    ...
    <div class="alert alert-success d-flex align-items-start w-50 mx-auto p-3">
        ...
        <div>
            ...
            Запись с идентфикатором <b>{{ $id }}</b> добавлена в таблицу <b><u>products</u></b>
        </div>
    </div>
