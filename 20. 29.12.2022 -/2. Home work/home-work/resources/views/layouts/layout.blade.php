            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark">
                        <li><a class="dropdown-item" href="/tables/films">Фильмы</a></li>
                        <li><a class="dropdown-item" href="/tables/producers">Режиссеры</a></li>
                        <li><a class="dropdown-item" href="/tables/genres">Жанры</a></li>
                        <li><a class="dropdown-item" href="/tables/countries">Страны</a></li>
                    </ul>
                </li>

                <!-- Скачать данные -->
                <li class="nav-item">
                    <a class="nav-link mx-3 @yield('downloadDataActive')"
                       href="/tables/download-data">
                        Скачать данные
                    </a>
                </li>
                ...
                <!-- Загрузить данные -->
                <li class="nav-item">
                    <a class="nav-link mx-3 @yield('uploadDataActive')"
                       href="/tables/upload-data">
                        Загрузить данные
                    </a>
                </li>
