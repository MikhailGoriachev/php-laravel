...
<!-- секция контент -->
@section('main_part')
    <h4 class="text-center my-5">Страница redirect-demo/handler</h4>
    ...
    <div class="alert alert-info d-flex align-items-start w-50 mx-auto p-3">
        <svg class="bi flex-shrink-0 me-3" width="24" height="24">
            <use xlink:href="#exclamation-triangle-fill"/>
        </svg>
        <div>
            <strong>К сведению</strong><br>
            Получен параметр: <strong>{{ $param }}</strong><br>
        </div>
    </div>
