...
<head>
    ...
    <title>Занятие 29.12.2022</title>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="appNavbar-1">
                    <ul class="navbar-nav">
                        ...
                        {{-- переход на страницу генерации исключений --}}
                        <li class="nav-item">
                            <a class="nav-link @yield('active_exceptions')" href="/error-generator"
                               title="Переход на страницу генерации исключений">Исключения</a>
                        </li>

                        {{-- переход на страницу генерации исключений --}}
                        <li class="nav-item">
                            <a class="nav-link @yield('active_redirections')" href="/redirect-demo"
                               title="Переход на страницу демонстрации переадресаций">Переадресация</a>
                        </li>

                        {{-- переход на страницу вывода сведений --}}
                        <li class="nav-item">
