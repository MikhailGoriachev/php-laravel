...
?>
    <section class="mx-5 my-4 bg-light shadow-sm border rounded-3 min-vh-100 p-3">
        ...
        <h4 class="text-center">Запрос 03 <?= $isStartData ? '' : "(Паспорт: $passport)" ?></h4>
            ...
            <div class="row">
                ...
                <div class="col my-auto">
                    ...
                    <a class="btn btn-warning my-auto <?= $isStartData ? 'disabled' : '' ?>"
                       href="/pages/task02/queries/query03.php">Сброс</a>
                </div>
            </div>
        </form>


        <?= $queries->toTableData($isStartData ? $tables->getExams() : $queries->query03($passport), Exam::headerTable()) ?>
