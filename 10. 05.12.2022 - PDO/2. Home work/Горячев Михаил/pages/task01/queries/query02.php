...
?>
    <section class="mx-5 my-4 bg-light shadow-sm border rounded-3 min-vh-100 p-3">
        ...
        <h4 class="text-center">Запрос 02 (Диапазон страховой стоимости: <?= $minInsurance ?> — <?= $maxInsurance ?>)</h4>

        <?= $task->toTableData($task->query02($minInsurance, $maxInsurance), Car::headerTable()) ?>
