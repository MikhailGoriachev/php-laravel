                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @yield('active_read')" href="/read-data"
                               title="Переход на страницу чтения данных из таблиц">Чтение данных</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link @yield('active_update')" href="/products/update/1"
                               title="Переход на страницу редактирования данных">Изменение данных</a>
                        </li>

                        <!-- Переход на страницу удаления данных -->
                        <li class="nav-item">
                            <a class="nav-link @yield('active_delete')" href="/products/delete/1"
