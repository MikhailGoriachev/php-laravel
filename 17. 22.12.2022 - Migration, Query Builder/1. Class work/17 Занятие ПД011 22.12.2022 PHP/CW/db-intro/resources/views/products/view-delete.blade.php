...
<!-- секция контент -->
@section('main_part')
    <h4 class="text-center my-5">Удаление записи о товаре с идентфиикатором {{ $id }}</h4>
    ...
    <div class="alert alert-success d-flex align-items-start w-50 mx-auto p-3">
        ...
        <div>
            ...
            Запись с идентфикатором <b>{{ $id }} {{ $num == 0?"НЕ":"" }}</b> удалена из таблицы <b><u>products</u></b><br>
            Всего удалено записей: <b>{{ $num  }}</b>
        </div>
    </div>
