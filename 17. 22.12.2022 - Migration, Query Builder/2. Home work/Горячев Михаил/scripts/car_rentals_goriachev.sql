...
INSERT INTO `rentals` VALUES (1,1,2,'2021-11-05',5),(2,4,2,'2021-11-03',3),(3,4,5,'2021-11-04',9),(4,1,3,'2021-11-01',4),(5,7,7,'2021-11-13',7),(6,3,1,'2021-11-01',8),(7,4,8,'2021-11-07',9),(8,7,9,'2021-11-02',10),(9,6,2,'2021-11-08',7),(10,8,4,'2021-11-09',2),(11,1,1,'2021-11-01',3),(12,2,7,'2021-11-12',1),(13,3,2,'2021-11-07',1),(14,7,8,'2021-11-02',9),(15,5,3,'2021-11-09',7),(16,8,5,'2021-11-07',5),(17,6,9,'2021-11-01',7),(18,8,6,'2021-11-10',1),(19,1,3,'2021-11-02',10),(20,8,2,'2021-11-05',1),(21,4,2,'2021-11-04',10),(22,1,3,'2021-11-01',2),(23,4,5,'2021-11-03',3);
...
/*!50001 VIEW `cars_view` AS select `cars`.`id` AS `id`,`brands`.`name` AS `brand_name`,`colors`.`name` AS `color_name`,`cars`.`plate` AS `plate`,`cars`.`year_manufacture` AS `year_manufacture`,`cars`.`inshurance_pay` AS `inshurance_pay`,`cars`.`rental` AS `rental` from ((`cars` join `brands` on((`cars`.`id_brand` = `brands`.`id`))) join `colors` on((`cars`.`id_color` = `colors`.`id`))) */;
...
-- Dump completed on 2022-12-08 14:46:18
